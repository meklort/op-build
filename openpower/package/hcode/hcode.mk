...
# TODO get ringfile building working instead of pulling from hostboot_binaries!
...
#ifeq ($(BR2_NO_BLOBS),n)
#HCODE_ENV_VARS += RINGFILEPATH=$(STAGING_DIR)/hostboot_binaries __EKB_PREFIX=$(CXXPATH) \
#        CONFIG_IONV_FILE_LOCATION=$(STAGING_DIR)/hostboot_binaries/$(BR2_HOSTBOOT_BINARY_IONV_FILENAME)
#else
#HCODE_ENV_VARS += RINGFILEPATH=$(@D)/rings/ __EKB_PREFIX=$(CXXPATH)
#endif
